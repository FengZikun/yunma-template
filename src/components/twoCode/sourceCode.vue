  ...
  export default{
    ...
    methods:{
      init:function(currentPage){
        var self=this;
        var url='http://192.168.1.109:8080/cloud_code/GET/product/productInfoList.do';
        var type='get';
        var data={
      ...
      source:function(){
        ...
        if(parseInt(self.proNum)<=parseInt(self.proCount)){
          ...
          var url='http://120.77.149.115/cloud_code/POST/productTracing/createProductTracingCode.do';
          var type='post';
          var data={
